            ...
            <div class="max-w-lg mx-auto lg:max-w-none">
                <form class="flex">
                    <div class="p-1 flex items-center">
                        <label for="tmdb_id_g"
                               class="block text-sm font-medium text-gray-700 md:mr-4">Tmdb Id</label>
                    ...
                    <div class="mt-2 md:flex">
                        <span class="inline-flex rounded-md shadow-sm">
                            <button
                                ...
                                class="inline-flex items-center justify-center py-2 px-4 text-base leading-6 font-medium rounded-md text-white bg-green-500 hover:bg-green-700 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-green-700 transition duration-150 ease-in-out disabled:opacity-50">
                             ...
                             <button
                                 ...
                                 class="inline-flex items-center justify-center py-2 px-4 text-base leading-6 font-medium rounded-md text-white bg-green-600 hover:bg-green-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-green-700 transition duration-150 ease-in-out disabled:opacity-50">
                                <svg v-if="isLoading" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none"
                                     viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor"
                            ...
                            <tr v-for="cast in casts" :key="cast.id" >
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                    <div class="flex justify-around">
                                        <button @click.prevent="editCast(cast)" class="text-green-500 hover:text-green-700">Edit</button>
