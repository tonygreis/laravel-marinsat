        ...
        <div v-if="isShowingForm" class="bg-white py-4 px-4 sm:px-6 mt-2 lg:col-span-3 xl:pl-12 shadow overflow-hidden border-b border-gray-200 rounded-lg">
            <div class="max-w-lg mx-auto lg:max-w-none">
                <form class="grid grid-cols-1 row-gap-6 mt-2">
                     ...
                     <div class="mt-2 md:flex md:items-center">
                        <label for="season_number" class="block text-sm font-medium text-gray-700 md:mr-4">Season Nr</label>
                        <div class="relative rounded-md shadow-sm flex-auto">
                            <input
                            ...
                            <tr v-for="season in seasons" :key="season.id">
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                    <div class="flex justify-around">
                                        ...
                                        <button @click.prevent="editSeason(season)" class="text-green-600 hover:text-green-900">Edit</button>
