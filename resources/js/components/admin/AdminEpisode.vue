                    ...
                    <div class="p-1">
                        <span class="inline-flex rounded-md shadow-sm">
                            <button
                                ...
                                class="inline-flex items-center justify-center py-2 px-4 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-green-600 hover:bg-green-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green active:bg-green-700 transition duration-150 ease-in-out disabled:opacity-50">
        ...
        <div v-if="isShowingForm" class="bg-white py-4 px-4 sm:px-6 mt-2 lg:col-span-3 xl:pl-12 shadow overflow-hidden border-b border-gray-200 rounded-lg">
            ...
            <div class="max-w-lg mx-auto lg:max-w-none">
                <form class="grid grid-cols-1 mt-2">
                    ...
                    <div class="mt-2 md:flex md:items-center">
                        <label for="episode_number" class="block text-sm font-medium text-gray-700 md:mr-4">Episode Nr</label>
                        <div class="relative rounded-md shadow-sm flex-auto">
                            <input
                    ...
                    <div class="mt-2 md:flex md:items-center">
                        <label for="overview" class="block text-sm font-medium text-gray-700 md:mr-4">Overview</label>
                        <div class="relative rounded-md shadow-sm flex-auto">
                            <input
                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg mt-4">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr v-for="episode in episodes" :key="episode.id">
                                ...
                                <td class="w-4/12 px-6 py-4 whitespace-no-wrap">
                                    <span class="font-bold text-green-500" v-if="episode.is_public">Public</span>
                                    <span class="font-bold text-red-500" v-else>False</span>
                                </td>
                                <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                    <div class="flex justify-around">
                                       <button @click.prevent="editEpisode(episode)" class="text-green-600 hover:text-green-900">Edit</button>
