            ...
            <div class="max-w-lg mx-auto lg:max-w-none">
                <form class="grid grid-cols-1 row-gap-6">
                    <div class="p-1 flex items-center">
                        <label for="tag_name" class="block text-sm font-medium text-gray-700 md:mr-4">Tag Name</label>
                            ...
                            <tr v-for="tag in tags" :key="tag.id" >
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-right text-sm leading-5 font-medium">
                                    <div class="flex justify-around">
                                        <button @click.prevent="editTag(tag)" class="text-green-600 hover:text-green-900">Edit</button>
