     ...
     <x-front.card>
        <x-slot name="image">
            <div class="aspect-w-2 aspect-h-3">
                ...
                <a href="{{ route('casts.show', $cast->slug) }}" class="hover:scale-110 text-white opacity-0 transform translate-y-3 group-hover:translate-y-0 group-hover:opacity-100 transition">
            ...
            <a href="{{ route('casts.show', $cast->slug) }}">
                <h3 class="text-white font-bold group-hover:text-blue-300 text-sm">{{ $cast->name }}</h3>
            </a>
      </x-front.card>
    @endforeach
      @endif
