<x-front-layout>
    <main class="max-w-6xl mx-auto p-2 rounded-lg my-2">
        ...
        @if(!empty($movie))
                ...
                >
                    ...
                    <div class="flex flex-wrap bg-main-blue mt-2 rounded">
                        @foreach($movie->trailers->merge($movie->embeds) as $count => $embed)
                            ...
                            focus:outline-none focus:bg-main-mavi hover:bg-main-mavi
                            font-bold rounded shadow tablink bg-main-rose"
            ...
            @endif
            <section class="container mx-auto bg-gray-900 rounded m-2">
                <div class="grid grid-cols-12">
                    <div class="col-span-12 md:col-span-8 lg:col-span-8">
                        <div class="flex p-2 bg-main-gray m-2 rounded">
                            <div class="w-3/12">
                                <div class="w-full">
                                    <img
                                        class="lozad blur w-full h-full rounded hover:opacity-75 transition transition-900 transition-ease-in bg-yellow-900"
                        ...
                        <div class="m-2 p-2 bg-main-gray rounded">
                                    ...
                                    @foreach($movie->casts as $cast)
                                        <div class="relative">
                                            <a href="{{ route('casts.show', $cast->slug) }}">
                                                ...
                                                <noscript>
                                                    <img
                                                        class="lozad blur w-full h-full rounded-lg hover:opacity-75 transition transition-900 transition-ease-in bg-yellow-900"
                                                        data-src="{{ asset('storage/cast/'.$cast->poster_path)  }}"
                        ...
                        <div class="container mx-auto p-2 m-2">
                            @if(!empty($movie->watchs))
                                <div class="bg-main-gray my-2 py-2 rounded">
                                    ...
                                    <div class="flex flex-wrap">
                                        @foreach($movie->downloads as $download)
                                            <a href="{{ $download->web_url }}" target="_blank">
                                                <div
                                                    class="flex mt-1 h-18 ml-1 p-2 hover:bg-main-mavi text-gray-300 hover:text-gray-500 rounded border border-blue-500 transition-bg transition-500 transition-ease-in">
                    ...
                    <div class="col-span-12 md:col-span-4 lg:col-span-4 p-2 mx-2 bg-main-gray mt-2">
                        <div class="w-full p-2 text-yellow-700">Te Fundit</div>
                        @if(!empty($latest))
            ...
            <section>
                @if(!empty($movie->tags))
                    <div class="container mx-auto m-2">
                        <div class="flex flex-wrap bg-main-light rounded">
