        ...
        <div class="container mx-auto mt-3">
            <div class="flex justify-center md:flex-row flex-wrap rounded bg-main-gray">
                ...
                <div class="w-full md:w-3/4 p-4 text-center md:text-left">
                    <h1 class="text-lg text-main-mavi font-bold mx-8">{{ $serie->name }} me titra shqip.</h1>
     ...
     <x-front.card>
        <x-slot name="image">
            <div class="aspect-w-2 aspect-h-3">
                ...
                <a href="{{ route('seasons.show', [$serie->slug, $season->slug]) }}" class="hover:scale-110 text-white opacity-0 transform translate-y-3 group-hover:translate-y-0 group-hover:opacity-100 transition">
